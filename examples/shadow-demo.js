  ...
  render_scene(
    ...
    for (let i of [-1, 1]) {
      ...
      this.shapes.teapot.draw(
        ...
        program_state,
        model_transform,
        shadow_pass ? this.stars : this.pure
      );
    }
    ...
    let model_trans_wall_1 = Mat4.translation(-8, 2 - 0.1, 0).times(
      Mat4.scale(0.33, 2, 5)
    );
    let model_trans_wall_2 = Mat4.translation(+8, 2 - 0.1, 0).times(
      Mat4.scale(0.33, 2, 5)
    );
    let model_trans_wall_3 = Mat4.translation(0, 2 - 0.1, -5).times(
      Mat4.scale(8, 2, 0.33)
    );
